...
.workflowicon{height: 60px;width:60px;font-size: 3.8em;padding-top: 4px;}
</style>
...
<div id="OAtop">
	...
	<li><a href="/Plat/Blog/" target="_blank"><i class="fa fa-universal-access workflowicon"></i><br />工作流</a></li>
	<li><a href="/User/CloudManage?Type=file" target="_blank"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-cloud fa-stack-1x fa-inverse"></i></span><br />网络云盘</a></li>
	...
	<li><a href="javascript:;" onclick="ShowMain('','/Office/Flow/ApplyList.aspx')"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-list-alt fa-stack-1x fa-inverse"></i></span><br />信息管理</a></li>
...
<li><a href="javascript:;" onclick="ShowMain('','/Office/UserConfig.aspx');">配置</a></li> 
<li><a href="http://code.z01.com/webOffice.rar">组件下载</a></li>              
</ul>
<ul class="nav_ulr">
<li><a href="/Office/" title="首页"><i class="fa fa-home"></i></a></li> 
<li><a href="javascript:;" onclick="ShowMain('','/Office/Other/StructList.aspx?action=struct&value=2');" title="组织结构"><i class="fa fa-group"></i></a></li>        
<li><a href="javascript:;" onclick="ShowMain('','/Office/UserConfig.aspx');" title="设置"><i class="fa fa-gear"></i></a></li>  
<li title="退出"><a href="/User/User/Logout?url=/Office/" title="退出"><i class="fa fa-power-off"></i></a></li> 
</ul>
</div>
</div>
<div class="oamain">
