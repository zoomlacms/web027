...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-bordered table_red1">
        ...
        <tr runat="server" id="ReferUser_TR">
            <td>
                <input type="button" class="btn btn-primary pull-right" onclick="selrefer();" value="主办人" runat="server" id="ReferUser_Btn" /></td>
            <td>
                <asp:Label runat="server" ID="ReferUser_T" Style="height: 60px; word-wrap: break-word;"></asp:Label>
        ...
        <tr runat="server" id="CCUser_TR">
            ...
            <td>
                <asp:Label runat="server" ID="CCUser_T" Style="height: 60px; word-wrap: break-word;"></asp:Label>
        ...
        <tr runat="server" id="HelpUser_TR">
            <td><input type="button" class="btn btn-primary pull-right" onclick="selhelpuser();" value="辅办人" runat="server" id="HelpUser_Btn" /></td>
             <td>
                <asp:Label runat="server" ID="HelpUser_T" Style="height: 60px; word-wrap: break-word;"></asp:Label>
