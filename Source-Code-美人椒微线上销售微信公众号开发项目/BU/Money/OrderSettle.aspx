<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderSettle.aspx.cs" Inherits="ZoomLaCMS.BU.Money.OrderSettle" MasterPageFile="~/Common/Master/User.Master" %>
...
<table class="table table-bordered table-striped">
    ...
    <tr><td></td><td><asp:Button runat="server" ID="Save_Btn" Text="结清订单" OnClick="Save_Btn_Click" OnClientClick="return confirm('确定要结清吗,将会同步修改已支付数据');" class="btn btn-primary"/></td></tr>
</table>
</div>
</asp:Content>
