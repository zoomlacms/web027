...
function PreViewImg(url) {
    ...
    if (!$("#view_div")[0]) {
        $("body").append($("<div id='view_div' style='display:none;'><img style='width:100%' onerror='this.src=\"/Images/nopic.gif\";' id='view_img' /></div>"));
    }
...
function ShowSelUser(source) {
    ShowDiag("/Office/Mail/SelGroup.aspx?Type=AllInfo#" + source, "选择用户");
}
