...
<script>
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({
            title: '我是<%=NickName.Text%>,我为美人椒代言', // 分享标题
            desc: '美人椒“鲜鲜鲜”睡足100天，选材鲜、工艺鲜、味道鲜。', // 分享描述
...
<li><a href="/wxpromo.aspx?r=/Class_7/Default.aspx"><i class="fa fa-shopping-bag"></i>商品</a></li>
<li><a href="/wxpromo.aspx?r=/Cart/Cart.aspx"><i class="fa fa-shopping-cart"></i>购物车</a></li>
<li><a href="/wxpromo.aspx?r=/User/"><i class="fa fa-user"></i>我</a></li>
</ul>
</div>
</div>
</form>
...
<script>
var ProID=parseInt('<%Call.Label("{ZL.Label id=\"输出当前用户审核通过商品ID\"/}");%>');
console.log(ProID)
if(ProID>=1) {
	$("#Image1").attr("src",'/Common/Common.ashx?url=<%Call.Label("{ZL.Label id=\"获取当前用户分享链接\"/}");%>');
}
</script>