<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mbview.aspx.cs" Inherits="Design_h5_mbview" EnableViewState="false"%>
<!DOCTYPE html>
<html>
<head>
...
#eraser {position: absolute;z-index: 999;height:525px;width:320px;left:32px;top:170px;}
...
<div class="pcview" ng-app="app" ng-controller="appCtrl">
    ...
    <div class="code_div">
        ...
        <div class="img_div">
            <img src="/common/common.ashx?url=<%=ZoomLa.Components.SiteConfig.SiteInfo.SiteUrl+"/h5/"+pageMod.ID%>" />
        </div>
...
<iframe style="display:none;" src="/CallCounter.aspx?ztype=h5&id=<%:pageMod.ID %>&title=<%:pageMod.Title %>"></iframe>
...
<script>
    ...
    function setdefbk(){ $(".pcview_bg").css('background-image','url(/UploadFiles/bg_pcview.jpg)');}
