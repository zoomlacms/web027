<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BarConfig.aspx.cs" Inherits="ZoomLaCMS.Manage.Guest.BarConfig" MasterPageFile="~/Manage/I/Default.master" %>
...
<div class="tab-content barconfig">
    ...
    <div class="text-center Conent_fix">
        <asp:Button runat="server" CssClass="btn btn-primary" ID="AddBar_Btn" OnClientClick="return CheckData()" Text="保存信息" OnClick="AddBar_Btn_Click" />
        <a id="cencel_A" href="#" class="btn btn-primary">返回列表</a>
    </div>
    </div>
</asp:Content>
