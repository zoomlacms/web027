...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td><strong>方式名称：</strong></td>
            <td>
                <ZL:TextBox ID="payname" runat="server" AllowEmpty="false" class="form-control text_300 pull-left">Paypal国际在线支付</ZL:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="pay_intf" runat="server" ReadOnly="True" class="form-control text_300 pull-left">PayPal外贸必选(标准版)</asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="clientid" runat="server" class="form-control text_300 pull-left" />
                <span class="p9gray tips">此处填写您的支付帐号、客户号或客户id等，此帐号在支付服务提供商处取得；</span>
            </td>
        </tr>
        <tr>
            <td><strong>身份标记：</strong></td>
            <td>
                <asp:TextBox ID="title_T" runat="server" class="form-control text_300 pull-left" />
            </td>
        </tr>
        <tr>
            <td><strong>支持交易货币：</strong></td>
            <td class="style3">
                <asp:CheckBoxList ID="Currency_DP" runat="server" Height="83px" RepeatColumns="8" Width="586px">
        ...
        <tr>
            <td></td>
            <td><asp:Button ID="EBtnSubmit" Text="保存" OnClick="EBtnSubmit_Click" runat="server" class="btn btn-primary"/>
        </td>
        </tr>
    </table>
</asp:Content>
