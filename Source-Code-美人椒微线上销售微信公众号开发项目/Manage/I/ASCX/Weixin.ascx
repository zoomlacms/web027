...
<div id="wx_menu" class="left_ul">
    <ul class='m_left_ulin'>
        ...
        <li id="menu10_2_7" onclick="wxclick(this);"><a href="WeiXin/QrCodeManage.aspx" target='main_right'><%=Resources.L.二维扫码%></a></li>
        <li id="menu10_2_8" onclick="wxclick(this);"><a href="WeiXin/QrCodeDecode.aspx" target='main_right'><%=Resources.L.解码管理%></a></li>
        ...
        <asp:Repeater ID="RPT" runat="server">
            <ItemTemplate>
                ...
                <ul class="downmenu hidden">
                    ...
                    <li><a class="margin_l15" href="Weixin/SendWx.aspx?appid=<%#Eval("ID") %>" target='main_right'><i class="fa fa-comment"></i>发送消息</a></li>
                    <li><a class="margin_l15" href="Weixin/MsgsSend.aspx?appid=<%#Eval("ID") %>" target='main_right'><i class="fa fa-file-image-o"></i>图文群发</a></li>
