...
<table class="table table-striped table-bordered table-hover">
	<tbody>
        ...
        <tr>
            ...
            <td>
                <div><input type="checkbox" runat="server" id="DomainMerge_Chk" class="switchChk" /><span class="rspan">多域名绑定302跳到SiteUrl唯一地址</span></div>
                <div class="input-group margin_t5"><span class="input-group-addon">PC端</span><asp:TextBox runat="server" ID="Domain_PC_T" class="form-control text_300" placeholder="http://网址"/></div>
                <div class="input-group margin_t5"><span class="input-group-addon">手 机</span><asp:TextBox runat="server" ID="Domain_Mobile_T" class="form-control text_300" placeholder="http://网址"/></div>
                <div class="input-group margin_t5"><span class="input-group-addon">微 信</span><asp:TextBox runat="server" ID="Domain_Wechat_T" class="form-control text_300" placeholder="http://网址"/></div>
            </td>
        </tr>
		<tr>
        ...
        <tr>
            ...
            <td>
                <div class="input-group text_s">
                    <asp:TextBox ID="PointRatio_T" class="form-control text_300 float" runat="server" />
                    <span class="input-group-addon">%</span>
                </div>
                <span class="rd_green">(0或100视为关闭积分兑换)</span>
            </td>
        </tr>
        <tr>
