    ...
    <div class="newbody" id="newbody" style="display: none;" ondblclick="$(this).hide();">
        <div class="newbody_t">
            <div class="newbody_tl">
                ...
                <a onclick="javascript:$('.newbody').hide();showleft('menu10_1','/APP/Default')">移动开发</a>
    ...
    <div class="m_top">
                ...
                <td>
                    <div class="margin-15 padding0 m_top_right">
                        <div class="col-lg-9 col-md-10 col-sm-9 col-xs-12 hidden-xs">
                            <div style="height: 42px;" class="m_top_menu row">
                                <ul class="list-unstyled ">
                                    ...
                                    <li class="menu4" onclick="openmenu('menu4')"><a onclick="showleft('menu4_2');" title="<%=Resources.L.黄页 %>"><span class="visible-sm"><%=Resources.L.黄页 %></span><span class="hidden-sm"><%=Resources.L.黄页 %></span></a></li>
                        ...
                        <div class="col-lg-3 col-md-2 col-sm-3 col-xs-12 padding0 m_top_rl" style="padding-right: 20px;">
                            <div id="Announce">
                                <div class=" pull-right hidden-md hidden-sm hidden-xs Announce_r">
                                ...
                                <div class="dropdown pull-right topdrop">
                                    <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;" aria-expanded="false">
                                        <span runat="server" id="nameL"></span>
                            ...
                            <div class="pull-right search_btn" hidden>
                                <span class="fa fa-search" onclick="showsearch()"></span>
                            </div>
                            <div class="pull-right hidden_group" id="search_div">
        ...
        <div class="m_top_bottom hidden-xs">
            ...
            <ul class="menu3">
                ...
                <li class="menu3_2"><a onclick="showleft('menu3_2','Shop/Stock/StockManage.aspx')"><%=Resources.L.库存管理 %></a></li>
                ...
                <li class="menu3_5"><a onclick="showleft('menu3_5','Shop/SaleReport/SaleByDay.aspx')"><%=Resources.L.销售统计 %></a></li>
                <li class="menu3_6"><a onclick="showleft('menu3_6','Shop/Arrive/PromoList.aspx')"><%=Resources.L.促销优惠 %></a></li>
                <li class="menu3_7"><a onclick="showleft('menu3_7','Shop/Addon/exp/DeliverType.aspx')"><%=Resources.L.商城配置 %></a></li>
                ...
                <li class="menu3_13">
                    <div class="btn-group topdrop">
                        <button type="button" onclick="showleft('menu3_13','UserShopManage/StoreManage.aspx')" class="btn btn-default  btn-sm "><%=Resources.L.店铺管理 %></button>
                        <button type="button" class="btn btn-default  btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <span class="caret"></span><span class="sr-only"></span>
                        </button>
                        <ul class="dropdown-menu" role="menu">
                ...
                <%--<li class="menu3_14"><a onclick="showleft('menu3_14','Shop/3D/3DManage.aspx')">3D<%=Resources.L.店铺管理 %></a></li>--%>
            </ul>
            <ul class="menu4">
          <%--      <li class="menu4_1 active"><a onclick="showleft('menu4_1','Content/ModelManage.aspx?ModelType=10')"><%=Resources.L.黄页申请 %></a></li>--%>
                <li class="menu4_2"><a onclick="showleft('menu4_2','/AdminMVC/Page/ApplyAudit')">黄页管理</a></li>
                <li class="menu4_4"><a onclick="ShowMain('PageTree.ascx','/AdminMVC/Page/PageContent')">内容管理</a></li>
                <li class="menu4_5"><a onclick="showleft('menu4_5','Content/ModelManage.aspx?ModelType=10')">模型管理</a></li>
                <li class="menu4_4"><a onclick="ShowMain('menu4_2','/AdminMVC/Page/PageTemplate?ID=-1')">公用栏目</a></li>
                <li class="menu4_7"><a onclick="showleft('menu4_2','/AdminMVC/Page/PageConfig')">黄页配置</a></li>
            </ul>
            <ul class="menu5">
                <li class="menu5_1"><a onclick="ShowMain('QuestGuide.ascx?url=/AdminMVC/Exam/Papers_System_Manage','/AdminMVC/Exam/Papers_System_Manage')"><%=Resources.L.试卷管理 %></a></li>
                <li class="menu5_9"><a onclick="ShowMain('QuestGuide.ascx','/AdminMVC/Exam/QuestList')"><%=Resources.L.试题管理 %></a></li>
                <%--<li class="menu5_10"><a onclick="ShowMain('ExamGuide.ascx','/AdminMVC/Exam/QuestList')"><%=Resources.L.按年级管理 %></a></li>--%>
                <li class="menu5_7"><a onclick="showleft('menu5_7','/AdminMVC/Exam/Papers_System_Manage')"><%=Resources.L.组卷配置 %></a></li>
                <li class="menu5_3"><a onclick="showleft('menu5_3','/AdminMVC/Exam/ClassRoomManage')"><%=Resources.L.班级管理 %></a></li>
            ...
            <ul class="menu6">
                ...
                <li class="menu6_3"><a onclick="showleft('menu6_3','User/Auth/PermissionInfo.aspx')"><%=Resources.L.用户角色 %></a></li>
                ...
                <li class="menu6_6"><a onclick="showleft('menu6_6','User/Job/Jobsconfig.aspx')"><%=Resources.L.人才招聘 %></a></li>
     ...
     <%--           <li class="menu7_7"><a onclick="showleft('menu7_7','File/Addlinkhttp.aspx')"><%=Resources.L.站内链接 %></a></li>--%>
            ...
            <ul class="menu10">
                ...
                <li class="menu10_2"><a onclick="ShowMain('Weixin.ascx','WeiXin/home.aspx');">微信应用</a></li>
                <li class="menu10_6"><a onclick="showleft('menu10_5','TouTiao/TouTiaoContent.aspx');">头条号管理</a></li>
            ...
            <ul class="menu11">
                ...
                <li class="menu11_4"><a onclick="showleft('menu11_1','Site/Default.aspx')">IIS站点</a></li>
            ...
            <div id="left_ul_div">
                ...
                <div id="menu3" class="m_left_ul">
                    ...
                    <ul id="menu3_2" class="m_left_ulin">
                        ...
                        <li id="menu3_2_1"><a href="javascript:;" data-url="Shop/Stock/StockManage.aspx"><%=Resources.L.库存管理 %></a></li>
                        <li id="menu3_2_2"><a href="javascript:;" data-url="Shop/Stock/Stock.aspx"><%=Resources.L.入库出库 %></a></li>
                    </ul>
                    <ul id="menu3_3" class="m_left_ulin">
                        ...
                        <li id="menu3_3_20"><a href="javascript:;" data-url="Shop/Addon/After/SettleList.aspx">订单结清</a></li>
                        <li id="menu3_3_11"><a href="javascript:;" data-url="Shop/FillOrder.aspx">补入订单</a></li>
                    ...
                    <ul id="menu3_4" class="m_left_ulin">
                        ...
                        <li id="menu3_4_4"><a href="javascript:;" data-url="Shop/Addon/invoice/InvoiceList.aspx"><%=Resources.L.发票明细 %></a></li>
                    ...
                    <ul id="menu3_7" class="m_left_ulin">
                        ...
                        <li id="menu3_7_10"><a href="javascript:;" data-url="Shop/Addon/invoice/InvtoManage.aspx"><%=Resources.L.发票计算 %></a></li>
                    </ul>
            ...
            <ul class="list-unstyled">
                ...
                <!--<li id="menu3_8_11"><a href="javascript:;" data-url="Shop/profile/LmUserManage.aspx">联盟会员</a></li>-->
                    ...
                    <ul id="menu3_13" class="m_left_ulin">
                        ...
                        <li id="menu3_13_2"><a href="javascript:;" data-url="Content/ModelManage.aspx?ModelType=6">申请模型</a></li>
                        <%--<li id="menu3_13_3"><a href="javascript:;" data-url="UserShopManage/StoreStyleManage.aspx">店铺模板</a></li>--%>
                        <li id="menu3_13_4"><a href="javascript:ShowMain('UserShopNodeTree.ascx','Shop/ProductManage.aspx?StoreID=-1',this);">店铺商品</a></li>
                        <li id="menu3_13_6"><a href="javascript:;" data-url="UserShopManage/ShopinfoManage.aspx">店铺信息</a></li>
                        <li id="menu3_13_8"><a href="javascript:;" data-url="UserShopManage/ShopSearchKey.aspx">店铺配置</a></li>
                        ...
                        <li id="menu3_13_15"><a href="javascript:;" data-url="UserShopManage/ShopMailConfig.aspx">店铺邮件</a></li>
                    </ul>
<%--                    <ul id="menu3_14" class="m_left_ulin">
                        <li class="menu_tit"><span class="fa fa-chevron-down"></span>3D<%=Resources.L.店铺管理 %></li>
                        <li id="menu3_14_1"><a href="javascript:;" data-url="Shop/3D/3DManage.aspx">3D<%=Resources.L.店铺管理 %></a></li>
                        <li id="menu3_14_2"><a href="javascript:;" data-url="Shop/3D/AddShop.aspx"><%=Resources.L.添加店铺 %></a></li>
                    </ul>--%>
                </div>
                <div id="menu4" class="m_left_ul">
                    <ul class="m_left_ulin" id="menu4_2">
                        <li class="menu_tit"><span class="fa fa-chevron-down"></span>黄页管理</li>
                    ...
                    <ul class="m_left_ulin" id="menu4_5">
                        ...
                        <li id="menu4_5_2"><a href="javascript:;" data-url="Content/ModelManage.aspx?ModelType=10">黄页申请模型</a></li>
                        <li id="menu4_5_1"><a href="javascript:;" data-url="Content/ModelManage.aspx?ModelType=4">黄页内容模型</a></li>
                    </ul>
                </div>
                <div id="menu5" class="m_left_ul">
                    ...
                    <ul class="m_left_ulin" id="menu5_6">
                        ...
                        <li id="menu5_6_3"><a href="javascript:;" data-url="Shop/Addon/invoice/InvoiceList.aspx">发票明细</a></li>
		...
		<li id="menu9_2_4"><a href="javascript:;" data-url="AddOn/StructAnalysis.aspx"><%=Resources.L.分析结构%></a></li>--%>
                ...
                <div id="menu10" class="m_left_ul">
                    ...
                    <ul class="m_left_ulin" id="menu10_5">
                        <li class="menu_tit"><span class="fa fa-chevron-down"></span>消息推送</li>
                        <li id="menu10_5_1"><a href="javascript:;" data-url="TouTiao/TouTiaoConfig.aspx">头条号配置</a></li>
                        <li id="menu10_5_2"><a href="javascript:;" data-url="TouTiao/AddTouTiaoContent.aspx">内容投递</a></li>
    ...
    function wxclick(li) {
        ...
        if ($this.hasClass('wx_item')) {
            ...
            if (!$menu.hasClass('hidden')) { $menu.addClass('hidden'); }
                ...
                $("#wx_menu .downmenu").addClass('hidden');
