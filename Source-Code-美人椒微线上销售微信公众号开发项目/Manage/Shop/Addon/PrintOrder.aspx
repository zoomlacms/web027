...
<div class="container">
    <div class="poinfo">
        <div class="pull-left">订单编号：<asp:Label runat="server" ID="OrderNo_T"/></div>
        <div class="pull-right">订购时间： <asp:Label runat="server" ID="AddTime_T"/></div>
        <div class="clearfix"></div>
    </div>
    <div class="inforow">客户姓名：<asp:Label runat="server" ID="ReUserName_L"/></div>
    <div class="inforow">联系方式：<asp:Label runat="server" ID="Mobile_L"/></div>
    <div class="inforow">客户地址：<asp:Label runat="server" ID="Address_L"/></div>
    <hr />
    <div class="prolist">
        <table class="table table-bordered table-striped">
            ...
            <asp:Repeater runat="server" ID="RPT" EnableViewState="false">
                <ItemTemplate>
                   <tr><td><%#Eval("ProID") %></td><td><%#Eval("ProName") %></td><td><%#Eval("ProNum") %></td><td><%#Eval("AllMoney","{0:f2}") %></td></tr>
                </ItemTemplate>
            </asp:Repeater>
        </table>
        ...
        <div class="price_div">
            <div><span class="sp_l">商品总金额：</span>
                 <span class="sp_r"><asp:Label runat="server" ID="P_Pro_L"/></span>
            </div>
            <div><span class="sp_l">优惠券：</span><span class="sp_r"><asp:Label runat="server" ID="P_Arrive_L" Text="尚未支付"/></span></div>
            <div><span class="sp_l">使用积分：</span><span class="sp_r"><asp:Label runat="server" ID="P_Point_L" Text="尚未支付"/></span></div>
            <div><span class="sp_l">运费：</span>
                 <span class="sp_r"><asp:Label runat="server" ID="P_Exp_L"/></span>
            </div>
            <div>
                <span class="sp_l">实付：</span>
                <span class="sp_r"><strong><i class="fa fa-rmb"></i><asp:Label runat="server" ID="TotalMoney_L"/></strong></span>
            </div>
        </div>
        <div class="clearfix"></div>
