    ...
    <div id="Tabs0" class="tab-pane active manage_content">
        <table class="table table-striped table-bordered">
                <tbody>
                    ...
                    <tr><td><strong>短名称：</strong></td><td>
                        <asp:TextBox runat="server" class="form-control text_300" MaxLength="5" ID="ShortProName_T" />
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="text_md input-group">
                                <asp:TextBox ID="Weight_T" runat="server" class="form-control text_md" Text="0"/>
        ...
        <table class="table table-striped table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group text_s">
                                <asp:TextBox ID="BookPrice_T" runat="server" class="form-control text_s" autocomplete="off" /><span class="input-group-addon">元</span>
                            </div>
        ...
        <table class="table table-striped table-bordered">
                <tbody>
                    ...
                    <tr><td>特选商品：</td><td>
                        ...
                        <asp:HiddenField runat="server" ID="uprouids_hid" />
                        <asp:HiddenField runat="server" ID="uprouids_old_hid" /><!--无更改则不执行相关逻辑-->
                        <div id="upro_wrap"></div>
                    </td></tr>
                </tbody>
        </table>
        <script>
            $("#grouppro_td").load("/common/comp/GroupPro.aspx?ID=<%=proMod.ParentID%>");
            var upro = {
...
<div class="text-center Conent_fix">
    ...
    <a href="ProductManage.aspx?<%:"NodeID="+NodeID+"&StoreID="+UserShop_DP.SelectedValue%>" class="btn btn-primary">返回列表<i class="fa fa-arrow-circle-up"></i></a>
</div>
