<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowProduct.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.ShowProduct"MasterPageFile="~/Manage/I/Default.master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="tab-content panel-body padding0">
        ...
        <div id="Tabs4" class="tab-pane">
            <table class="table table-striped table-bordered">
                <tbody>
                    <tr>
                        <td class="td_l"><strong>单品组合：</strong></td>
                        <td>
    ...
    <div class="Conent_fix">
        ...
        <a href="AddProduct.aspx?ID=<%:Mid %>" class="btn btn-primary">修改商品</a>
        <a href="ProductManage.aspx?<%:"NodeID="+pinfo.Nodeid+"&StoreID="+pinfo.UserShopID %>" class="btn btn bg-primary">返回列表</a>
    </div>
</asp:Content>
