<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductManage.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.ProductManage" MasterPageFile="~/Manage/I/Default.master" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="<%$Resources:L,操作 %>" ItemStyle-CssClass="codetr">
                <ItemTemplate>
                    ...
                    <a class="option_style" href='<%#Eval("Class","").Equals("2") ? "Arrive/SuitProAdd.aspx?id="+Eval("ID") : "AddProduct.aspx?menu=edit&ModelID="+Eval("ModelID")+"&NodeID="+Eval("Nodeid")+"&id="+Eval("id") %>'><i class="fa fa-pencil" title="<%=Resources.L.编辑 %>"></i></a>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    <style>
        ...
        .popover { max-width: 500px; min-width: 150px; overflow-x: hidden; }
