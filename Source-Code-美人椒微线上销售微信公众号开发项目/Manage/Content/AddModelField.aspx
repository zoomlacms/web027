...
<tr>
	...
	<td>
		<asp:TextBox ID="Alias_T" runat="server" CssClass="form-control text_300" MaxLength="20" onkeyup="mfield.getpy('Alias_T','Name_T')"/>
...
<tr>
	...
	<td>
		<asp:TextBox ID="Name_T" MaxLength="50" CssClass="form-control text_300" runat="server" />
		<span class="tips rd_red">*</span>
...
<tr>
	...
	<td>
		<asp:TextBox ID="Tips" CssClass="form-control text_300" MaxLength="50" runat="server" />
...
<tbody id="DivOptionType" runat="server" class="mfield_body">
	<tr>
		...
		<td>
			...
			<asp:TextBox ID="RadioType_Content" runat="server" TextMode="MultiLine" Height="120px" CssClass="form-control text_300 margin_t5 mfield_txt" />
...
<tbody runat="server" id="DivListBoxType" class="mfield_body">
	<tr>
		...
		<td>
			...
			<asp:TextBox ID="ListBoxType_Content" runat="server" TextMode="MultiLine" Height="120px" CssClass="form-control text_300 margin_t5 mfield_txt" />
			<span style="color: red">*</span>
		</td>
	</tr>
	<tr>
...
<tr>
	<td></td><td>
		<asp:Button ID="Save_Btn" runat="server" Text="添加字段" CssClass="btn btn-primary" OnClientClick="return mfield.check()" OnClick="Save_Btn_Click" />
