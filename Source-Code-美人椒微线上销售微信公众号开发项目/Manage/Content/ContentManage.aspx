...
<title><%=Resources.L.内容管理 %></title>
 ...
 <%--   <style>.popover{max-width:200px;width:181px;}</style>--%>
</asp:Content>
	...
	<ItemTemplate>
		<tr ondblclick="location='ShowContent.aspx?GID=<%#Eval("GeneralID") %>';" data-order="<%#Eval("OrderID") %>" data-gid="<%#Eval("GeneralID") %>">
			...
			<td style="position:relative;">
                ...
                <a class="precode" href="javascript:;" <%#Eval("Status").ToString().Equals("99") ? "":"hidden" %> data-gid='<%#Eval("GeneralID") %>'><i class="fa fa-qrcode"></i></a>
                <a title="H5与移动创作" class="option_style" href="/design/h5/?id=<%#Eval("GeneralID") %>" target="_blank"><i class="fa fa-magic"></i></a>
                <a class="option_style" href="ShowContent.aspx?GID=<%#Eval("GeneralID") %>"  title="<%=Resources.L.预览 %>" ><i class="fa fa-eye"></i></a>
